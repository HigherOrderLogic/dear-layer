...
/// Slint platform that renders compiled components as Wayland layer-shell surfaces.
...
impl LayerShell {
    ...
    fn ensure_system(&self) -> Result<(), PlatformError> {
        ...
        let system = WaylandShellSystem::new_layer_shell_platform()
...
/// Handle for configuring a specific layer-shell surface by window title.
...
impl LayerShellWindow {
    ...
    pub fn set_output_policy(self, policy: OutputPolicy) -> Self {
    ...
    pub fn set_anchor(self, anchor: AnchorEdges) -> Self {
        self.config_state
            .borrow_mut()
    ...
    pub fn set_exclusive_zone(self, zone: i32) -> Self {
        self.config_state
            .borrow_mut()
    ...
    pub fn set_margins(self, margins: Margins) -> Self {
        self.config_state
            .borrow_mut()
    ...
    pub fn set_keyboard_interactivity(self, mode: KeyboardInteractivity) -> Self {
        self.config_state
            .borrow_mut()
    ...
    pub fn set_scale_factor(self, scale_factor: f32) -> Self {
        self.config_state
            .borrow_mut()
